...
Skid: enabled(bool), mode(std::string/string), increase, decrease, max, timeTillMax, slowdown, fadeIn, fadeOut, visual, visualTime, revertVisualTime, minSpeed, timeTillBonus(std::vector<float>/floatVector), bonusSpeed(std::vector<float>/floatVector), bonusTime(std::vector<float>/floatVector), fadeOutTime(std::vector<float>/floatVector), bonusForce(std::vector<float>/floatVector), physicalJumpTime, graphicalJumpTime, postSkidRotateFactor, reduceTurnMin, reduceTurnMax
Item: bonusBoxCap"""
