...
public:
    ...
    void saveCachedState(BareNetworkString *buffer) const { m_cached_characteristic->saveState(buffer); }
    void restoreCachedState(BareNetworkString *buffer) { m_cached_characteristic->restoreState(buffer); }
