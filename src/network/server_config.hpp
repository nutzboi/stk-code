...
namespace ServerConfig
{
    ...
    SERVER_CFG_PREFIX StringServerConfigParam m_available_modes
        SERVER_CFG_DEFAULT(StringServerConfigParam("d01234 m012345678", "available-modes",
    ...
    SERVER_CFG_PREFIX StringServerConfigParam m_item_policy
        ...
        "'bitstring' linear_multiplier items_per_lap progressive_cap progressive_penalty deg_mult fuel_mult item_number [item1 weight1 item2 weight2...]"));
