...
bool StandardRace::isRaceOver()
{
    ...
    if (UserConfigParams::m_ai_tv_mode && RaceManager::get()->getNumPlayers() == 0 /*|| UserConfigParams::m_tme_enable_leader_ends_race*/) {
...
void StandardRace::getDefaultCollectibles(int *collectible_type, int *amount)
{
    ...
    World::getDefaultCollectibles(collectible_type, amount);
